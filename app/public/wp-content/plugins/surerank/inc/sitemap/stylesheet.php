			...
			<xsl:template match="/">
				...
				<body>
					<div class="sitemap-container">
						...
						<p>This XML Sitemap was generated by the <a target="_blank" href="<?php echo esc_url( Utils::get_utm_url( 'https://surerank.com', 'sitemap', 'sitemap_footer_plugin_link' ) ); ?>">SureRank WordPress SEO Plugin</a>.  It helps search engines like Google, Bing, etc. crawl your website's posts, pages, products, images, and archives.</p>
